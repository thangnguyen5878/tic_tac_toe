...
class InputScreen extends StatelessWidget {
  ...
  TextFormField _buildPlayer1InputField() {
    ...
    return TextFormField(
      ...
      autofocus: false,
      onSaved: (value) {
        if (value != '') GlobalController.to.room.player1.name = value!;
      },
  ...
  TextFormField _buildPlayer2InputField() {
    ...
    return TextFormField(
      ...
      autofocus: false,
      onSaved: (value) {
        if (value != '') GlobalController.to.room.player2.name = value!;
      },
  ...
  TextFormField _buildColumnsInputField() {
    ...
    return TextFormField(
      ...
      onSaved: (value) {
        GlobalController.to.room.board.columns = int.tryParse(value!) ?? 0; 
      },
  ...
  TextFormField _buildRowsInputField() {
    ...
    return TextFormField(
      ...
      onSaved: (value) {
        GlobalController.to.room.board.rows = int.tryParse(value!) ?? 0;
      },
