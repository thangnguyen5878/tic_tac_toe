    ...
    return InkWell(
      child: GetBuilder(
        ...
        builder: (GlobalController controller) {
          if (GlobalController.to.room.board.cells[row][column].state ==
              CellState.crossWin) {
          ...
          return Container(
              ...
              decoration: BoxDecoration(
                  ...
                  color: bColor),
              child: Text(
                GlobalController.to.room.board.cells[row][column].content
                    .toString(),
      ...
      onTap: () {
        ...
        print(
            'Tap cell($row, $column) : ${GlobalController.to.room.currentPlayer.seed}');
        GlobalController.to
            .drawSeed(row, column, GlobalController.to.room.currentPlayer.seed);
      },
    );
  }
}
