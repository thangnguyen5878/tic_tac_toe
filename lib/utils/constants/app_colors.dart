...
const kGrey30 = Color.fromARGB(255, 208, 208, 208);
const kGrey45 = Color(0xFFAAA8A8);
const kBlue30 = Color(0xFF9C8CB7); // history details screen: previous and next turn buttons
const kPurple30 = Color(0xFFC196A4); // history details screen: play button
const kGreen30 = Color(0xFFCAF5C0);
const kGreen30_history = Color(0xFFB1DCAB); // player 2 winning cells
